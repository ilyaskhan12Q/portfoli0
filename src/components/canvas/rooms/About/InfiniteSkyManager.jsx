...
const AWARDS_DATA = {
    featured: {
        ...
        items: [
            { label: 'Winner - NeoHack 2025', date: 'Feb 2025', image: '/textures/about/FEATURED.webp', url: 'https://github.com/ilyaskhan12Q' },
            { label: 'Stoore da Pokhtunkhwa', date: '2024', image: '/textures/about/FEATURED.webp', url: 'https://github.com/ilyaskhan12Q' },
        ],
        platformConfig: {
            label: 'CONTESTS',
            color: '#1a1a1a',
    ...
    sotd: {
        ...
        items: [
            { label: 'FSc Pre-Engineering: 865/1100', date: 'BISE Mardan', image: '/textures/about/SOTDAYYOUNGMULTIGSAP.webp', url: 'https://github.com/ilyaskhan12Q' },
            { label: 'Matriculation Science: 1052/1100', date: 'BISE Mardan', image: '/textures/about/SOTDAYYOUNGMULTICSSWINNER.webp', url: 'https://github.com/ilyaskhan12Q' },
        ],
        platformConfig: {
            label: 'ACADEMICS',
            color: '#1a1a1a',
    ...
    sotm: {
        ...
        items: [
            { label: 'BS CS (AI) CGPA: 3.51/4.00', date: 'AWKUM', image: '/textures/about/SOTM.webp', url: 'https://github.com/ilyaskhan12Q' }
        ],
        platformConfig: {
            label: 'CGPA',
            color: '#1a1a1a',
    ...
    soty: {
        id: 'award-soty',
        layout: 'certificate_grid',
        title: 'Featured Winnings',
        items: [
            { label: 'First Place - NeoHack 2025', date: '2025', image: '/textures/about/SOTY.webp', url: 'https://github.com/ilyaskhan12Q' }
        ],
        platformConfig: {
            label: 'CHAMPION',
            color: '#1a1a1a',
...
const BALLOON_CONFIG = [
    ...
    { texture: '/textures/about/threejsduzybalon.webp', paintedTexture: '/textures/about/threejsduzybalon_painted.webp', label: 'LangChain', size: 'large', x: 2.5, y: 2.5, z: 0.2, phase: 1.5 },
    { texture: '/textures/about/GSAPduzybalon.webp', paintedTexture: '/textures/about/GSAPduzybalon_painted.webp', label: 'PyTorch', size: 'large', x: 0, y: 3, z: 0.5, phase: 3 },

    // Medium balloons - scattered around
    { texture: '/textures/about/JSSREDNIBALON.webp', paintedTexture: '/textures/about/JSSREDNIBALON_painted.webp', label: 'C++', size: 'medium', x: -4, y: 1, z: -0.3, phase: 0.8 },
    { texture: '/textures/about/csssrednibalon.webp', paintedTexture: '/textures/about/csssrednibalon_painted.webp', label: 'SQL', size: 'medium', x: 4, y: 1.5, z: -0.2, phase: 2.2 },
    { texture: '/textures/about/nextjssrednibalon.webp', paintedTexture: '/textures/about/nextjssrednibalon_painted.webp', label: 'n8n', size: 'medium', x: 0, y: 0.5, z: -0.4, phase: 4 },

    // Small balloons - background accents
    { texture: '/textures/about/htmlmalybalon.webp', paintedTexture: '/textures/about/htmlmalybalon_painted.webp', label: 'Linux', size: 'small', x: -5.5, y: 2.5, z: -0.8, phase: 1.2 },
    ...
    { texture: '/textures/about/figmamalybalon.webp', paintedTexture: '/textures/about/figmamalybalon_painted.webp', label: 'Gemini', size: 'small', x: -3, y: 4.5, z: -0.5, phase: 3.5 },
    { texture: '/textures/about/firebasemalybalon.webp', paintedTexture: '/textures/about/firebasemalybalon_painted.webp', label: 'Supabase', size: 'small', x: 3.5, y: 4, z: -0.6, phase: 4.5 },
];
