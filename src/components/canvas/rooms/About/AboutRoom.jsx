...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'ILYAS', subtitle: '< ai / ml & full-stack dev />' },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: 'AWARDS', subtitle: 'NeoHack 25 Winner • Stoore da Pokhtunkhwa' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: 'BS Computer Science (AI) @ AWKUM Mardan' },
