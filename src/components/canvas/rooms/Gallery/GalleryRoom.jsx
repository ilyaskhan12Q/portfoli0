...
const UNIQUE_PROJECTS = [
    {
        ...
        description: 'Autonomous Parcel Delivery Drone (APDD) is a GPS-guided quadcopter built on the F450 frame with a Pixhawk 2.4.8 flight controller running ArduCopter firmware. Designed to navigate GPS waypoints autonomously and release parcels via an MG90S servo-actuated hook on arrival.',
        techStack: ['/textures/gallery/jslogo.webp', '/textures/gallery/htmllogo.webp', '/textures/gallery/csslogo.webp']
    },
    {
        id: 'cancer_classifier',
        title: 'NEOHACK 25',
        front: '/textures/gallery/timberkittyprzod.webp',
        painted: '/textures/gallery/timberkittyprzod_painted.webp',
        url: 'https://github.com/ilyaskhan12Q/cancer-omics-classifier',
        description: 'Multi-Modal Cancer Omics Classifier fuses clinical, genomic, and transcriptomic data into a multi-modal machine learning pipeline to predict cancer outcomes. Achieved a perfect AUC score on the evaluation set and won the NeoHack 2025 hackathon.',
    ...
    },
    {
        ...
        url: 'https://github.com/ilyaskhan12Q',
        description: 'Production RAG-powered lead generation support agent utilizing n8n, Pinecone vector store, and Gemini embeddings. Structured, debugged, and optimized vector store ingestion pipelines and updated system prompts for high-converting lead capture.',
    ...
    },
    {
        ...
        url: 'https://github.com/ilyaskhan12Q',
        description: 'SpreadsheetAppBuilder (SAB) is an open-source engine converting natural-language prompts to spreadsheet-based applications via a JSON blueprint pipeline. Decoupled generation layers from rendering adapters, supporting both LibreOffice (Python/UNO) and Excel (Office.js).',
