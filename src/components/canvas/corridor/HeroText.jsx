...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for ILYAS split effect
    const letters = useMemo(() => [
        { char: 'I', baseX: -1.1, splitDir: -2.0, delay: 0 },
        { char: 'L', baseX: -0.55, splitDir: -1.0, delay: 0 },
        { char: 'Y', baseX: 0.0, splitDir: 0.0, delay: 0 },
        { char: 'A', baseX: 0.55, splitDir: 1.0, delay: 0 },
        { char: 'S', baseX: 1.1, splitDir: 2.0, delay: 0 },
    ], []);

    // Tagline words for split effect
    const taglineWords = useMemo(() => [
        { text: '<', baseX: -0.9, splitDir: -1.5, delay: 0 },
        { text: 'ai / ml', baseX: -0.42, splitDir: -0.7, delay: 0 },
        { text: 'engineer', baseX: 0.35, splitDir: 0.7, delay: 0 },
        { text: '/>', baseX: 0.9, splitDir: 1.5, delay: 0 },
    ], []);
